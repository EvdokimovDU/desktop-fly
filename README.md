...
<p align="center">
<b>Интерактивная 3D-симуляция плодовой мушки (Drosophila melanogaster) для Windows 10/11</b><br>
...
<p align="center">
  <i>Основано на оригинальном проекте: <a href="https://github.com/DenisSergeevitch/desktop-fly">DenisSergeevitch/desktop-fly</a></i>
</p>
...
## 🌟 Ключевые возможности (C# / .NET 10 + OpenGL)
...
- **Информационный HUD и всплывающие карточки**:
  ...
  - **Нижний инфо-блок**: При клике на нейроны или нажатии шоткатов снизу всплывает карточка с количеством задействованных нейронов и подробным описанием их биологической роли.
...
- **668 нейронов рабочей спайковой сети с ~19 000 синапсов (1 kHz LIF-симуляция)**:
...
| `Клик ЛКМ по холсту` | Тап по поверхности (испуг) | Сенсорные механорецепторы |
...
### Требования
* **Windows 10 / 11 x64**
* **.NET 10 SDK** (или запуск готового `DesktopFly.exe`)
...
- Проект разработан на базе оригинального репозитория: [DenisSergeevitch/desktop-fly](https://github.com/DenisSergeevitch/desktop-fly).
